namespace ReservationServer.Domain.Response;
...
public class SeatInventoryResponse
{
    ...
    public static SeatInventoryResponse AlreadyReservedResponse(string flightId, string seatNumber, Guid userId, string details) =>
